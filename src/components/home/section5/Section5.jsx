...
const Section5 = () => {
    return (
        <div className='containerSection5'>
            <section>
                <header>
                    <h2 className='section5Title'>When parents feel calm, kids do too
                    </h2>
                </header>
                <p className='pSection5Home'>Sample testimonials (you can easily replace with real ones).</p>
